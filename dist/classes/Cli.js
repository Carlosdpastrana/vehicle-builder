...
class Cli {
    ...
    createTruck() {
        inquirer
            ...
            .then((answers) => {
            const truck = new Truck(Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), parseInt(answers.towingCapacity), [] // Empty wheels, defaults will be created in Truck constructor
            );
    ...
    findVehicleToTow(truck) {
        inquirer
            ...
            this.performActions(); // Go back to the action menu after towing
        });
    }
